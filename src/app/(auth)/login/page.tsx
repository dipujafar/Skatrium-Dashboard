...
export const metadata: Metadata = {
  title: "Admin Login",
  description: "Admin login for Skatrium.",
};
...
const LoginPage = () => {
  return (
    <div style={{ backgroundImage: `url("/auth-page-bg.png")` }} className="flex justify-center items-center min-h-screen bg-no-repeat bg-cover origin-center relative z-0 text-main-color">
      <div className="absolute inset-0 bg-gradient-to-b from-[#1f1d1d] via-[#2b2b27] to-[#544211]   z-10"></div>
      <div className="flex justify-center items-center mx-auto md:px-12 px-11 py-10 rounded-[40px] bg-white/60 text-main-color z-20 relative min-w-[500px]">
        <div>
          <Image
            src={logo}
            alt="logo"
